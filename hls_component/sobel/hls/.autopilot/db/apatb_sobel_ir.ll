; ModuleID = 'C:/Users/office/Desktop/Sobel_Accelerator/hls_component/sobel/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sobel_ir(%"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(7) %in_stream, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* noalias nonnull dereferenceable(7) %out_stream) local_unnamed_addr #0 {
entry:
...
declare void @apatb_sobel_hw(i8*, i1*, i1*, i1*, i1*, i1*, i1*, i8*, i1*, i1*, i1*, i1*, i1*, i1*)
...
declare void @sobel_hw_stub(%"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* noalias nonnull)

define void @sobel_hw_stub_wrapper(i8*, i1*, i1*, i1*, i1*, i1*, i1*, i8*, i1*, i1*, i1*, i1*, i1*, i1*) #5 {
entry:
  %14 = call i8* @malloc(i64 7)
  %15 = bitcast i8* %14 to %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"*
  %16 = call i8* @malloc(i64 7)
  %17 = bitcast i8* %16 to %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"*
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* %15, i8* %0, i1* %1, i1* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* %17, i8* %7, i1* %8, i1* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  call void @sobel_hw_stub(%"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* %15, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* %17)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* %15, i8* %0, i1* %1, i1* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<8>, 1, 1, 1, '8', false>, 0>"* %17, i8* %7, i1* %8, i1* %9, i1* %10, i1* %11, i1* %12, i1* %13)
