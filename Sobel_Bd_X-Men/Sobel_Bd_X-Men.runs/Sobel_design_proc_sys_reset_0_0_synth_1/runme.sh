...
HD_PWD='C:/Users/office/Desktop/X_MEN_SOBEL/Sobel_Bd_X-Men/Sobel_Bd_X-Men.runs/Sobel_design_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sobel_design_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sobel_design_proc_sys_reset_0_0.tcl
